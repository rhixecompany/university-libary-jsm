...
export class Convert {
  public static toBook(json: string): Book[] {
    return cast(JSON.parse(json), a(r('Book')));
  }

  public static bookToJson(value: Book[]): string {
    return JSON.stringify(uncast(value, a(r('Book'))), null, 2);
  }
}
...
const typeMap: any = {
  Book: o(
    [
      ...
      { json: 'genre', js: 'genre', typ: u(undefined, '') },
      { json: 'rating', js: 'rating', typ: u(undefined, 0) },
      { json: 'coverUrl', js: 'coverUrl', typ: u(undefined, '') },
      { json: 'coverColor', js: 'coverColor', typ: u(undefined, '') },
      { json: 'description', js: 'description', typ: u(undefined, '') },
      { json: 'totalCopies', js: 'totalCopies', typ: u(undefined, 0) },
      { json: 'availableCopies', js: 'availableCopies', typ: u(undefined, 0) },
